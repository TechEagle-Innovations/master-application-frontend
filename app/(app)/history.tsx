...
// const BottomNav = React.memo(({ activeNav, onNavPress, style }: { activeNav: 'flights' | 'parcels'; onNavPress: (nav: 'flights' | 'parcels') => void; style: ViewStyle }) => (
//   <View
...
//     >
//       {activeNav === 'flights' ? <DroneActive size={25} className="text-primary" /> : <Drone size={24} className="text-gray-500" />}
//       <Text className={`${activeNav === 'flights' ? 'text-orange-600' : 'text-gray-500'} text-xs mt-1`}>Drones</Text>
//     </TouchableOpacity>
//     <TouchableOpacity
//       className="items-center justify-center flex-1 py-2"
...
//     >
//       {activeNav === 'parcels' ? <HistoryActive size={24} className="text-primary" /> : <History size={24} className="text-gray-500" />}
//       <Text className={`${activeNav === 'parcels' ? 'text-orange-600' : 'text-gray-500'} text-xs mt-1`}>History</Text>
//     </TouchableOpacity>
//   </View>
// ));
